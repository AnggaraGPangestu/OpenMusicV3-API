...
class AlbumLikesHandler {
  constructor(service, albumsService) {
    ...
    this.postSukaiHandler = this.postSukaiHandler.bind(this);
    this.getSukaiHandler = this.getSukaiHandler.bind(this);
  }

  async postSukaiHandler(request, h) {
    try {
  ...
  async getSukaiHandler(request, h) {
    try {
      const { albumId } = request.params;
