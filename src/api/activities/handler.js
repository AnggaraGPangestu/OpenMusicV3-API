...
class ActivitiesHandler {
  constructor(activitiesService, playlistService) {
    ...
    this.postAktivitasHandler = this.postAktivitasHandler.bind(this);
    this.getAktivitasHandler = this.getAktivitasHandler.bind(this);
  }

  async postAktivitasHandler(request, h) {
    try {
  ...
  async getAktivitasHandler(request, h) {
    try {
      const { id: credentialId } = request.auth.credentials;
      const { id } = request.params;
